...
$query_rs_wbfaq = "SELECT * FROM webfaq";
$rs_wbfaq = mysqli_query($Wandering, $query_rs_wbfaq) or die(mysqli_error());
$row_rs_wbfaq = mysqli_fetch_assoc($rs_wbfaq);
$totalRows_rs_wbfaq = mysqli_num_rows($rs_wbfaq);
?>
<!DOCTYPE html> 
<html  lang="zh-TW">
<head>
		...
		<div class="container">
			...
			<div class="right-side">
				...
				<div class="header-widget">
					...
					<a href="add-webfaq.php" class="button border with-icon">新增網站問答<i class="sl sl-icon-plus"></i></a>
				</div>
				<!-- Header Widget / End -->
			</div>
			<!-- Right Side Content / End -->
		...
		<div class="row">
			...
			<div class="col-lg-12 col-md-12">
				<div class="dashboard-list-box margin-top-0">
                    ...
                    <?php $havefaq = 0; if($totalRows_rs_wbfaq != 0){ ?>
					   	...
					   	<li>
							<div class="list-box-listing">
								<div class="list-box-listing-content">
									<div class="inner">
										<h3><?php echo $havefaq; ?>.<a href="#"><?php echo $row_rs_wbfaq['wQuestion']; ?></a></h3>
										<span><?php echo $row_rs_wbfaq['wAnswer']; ?></span>
																			
									</div>
								</div>
							</div>
							<div class="buttons-to-right">
                         		<a href="edit-webfaq.php?wId=<?php echo $row_rs_wbfaq['wId']; ?>" class="button gray"><i class="sl sl-icon-note"></i> 編輯</a>
								<a href="del-webfaq.php?wId=<?php echo $row_rs_wbfaq['wId']; ?>" class="button gray"><i class="sl sl-icon-close" onclick="javascript:return confirm('確定刪除問答「<?php echo $row_rs_wbfaq['wQuestion']; ?>」？')" ></i> 刪除</a>
							</div>
						</li>
                        <?php } while ($row_rs_wbfaq = mysqli_fetch_assoc($rs_wbfaq)); ?>
                       <?php }else{ ?>
                       
                      <h1><center> 尚未新增任何網站問答 </center></h1>
