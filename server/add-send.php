...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO send (sOrder, sName, sContent) VALUES (%s, %s, %s)",
  ...
  $insertGoTo = "show-send.php";
  if (isset($_SERVER['QUERY_STRING'])) {
    $insertGoTo .= (strpos($insertGoTo, '?')) ? "&" : "?";
    $insertGoTo .= $_SERVER['QUERY_STRING'];
  }
  header ('Content-type: text/html; charset=utf-8');
echo "<script>javascript:alert('已成功新增流程→" . $_POST['sName'] . "成功')</script>"; 
...
================================================== -->
          ...
          <div id="add-listing">
            ...
            <div class="add-listing-section">
              ...
              <div class="row with-forms">
                <div class="col-md-8">
                  <h5>流程內容</h5>
                  <input name="sName" type="text" required  class="search-field" placeholder="輸入流程標題" />
                </div>
                <div class="col-md-4">
                  <h5>流程排序<i class="tip" data-tip-content="越小越優先。"></i></h5>
                  <input name="sOrder" type="text" required  class="search-field" placeholder="輸入排序" value="1" />
                </div>
              </div>
              <!-- Row -->
              <div class="row with-forms">
 <div class="col-md-12">
                  <h5>流程內容</h5>
                  <textarea name="sContent"cols="40" rows="3" required class="WYSIWYG" id="summary" spellcheck="true"></textarea>
</div>
               <script>
