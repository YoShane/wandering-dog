...
$query_rs_team = "SELECT * FROM ourteam";
$rs_team = mysqli_query($Wandering, $query_rs_team) or die(mysqli_error());
$row_rs_team = mysqli_fetch_assoc($rs_team);
$totalRows_rs_team = mysqli_num_rows($rs_team);
?>
<!DOCTYPE html> 
<html  lang="zh-TW">
<head>
		...
		<div class="row">
			...
			<div class="col-lg-12 col-md-12">
				<div class="dashboard-list-box margin-top-0">
                    ...
                    <?php if($totalRows_rs_team != 0){ ?>
					  <?php do { ?>
					   	<li>
							<div class="list-box-listing">
								<div class="list-box-listing-img"><a href="#"><img src="../images/team/<?php echo $row_rs_team['oPicture']; ?>" alt=""></a></div>
								<div class="list-box-listing-content">
									<div class="inner">
										<h3><a href="#"><?php echo $row_rs_team['oName']; ?></a></h3>
										<span>工作職責-> <?php echo $row_rs_team['oWork']; ?></span>
							...
							<div class="buttons-to-right">
								...
								<a href="edit-teamperson.php?oId=<?php echo $row_rs_team['oId']; ?>" class="button gray"><i class="sl sl-icon-note"></i> 編輯</a>
								<a href="del-teamperson.php?oId=<?php echo $row_rs_team['oId']; ?>" class="button gray"  onclick="javascript:return confirm('確定刪除團隊成員「<?php echo $row_rs_team['oName']; ?>」？')" ><i class="sl sl-icon-close"></i> 刪除</a>
							</div>
						</li>
                        <?php } while ($row_rs_team = mysqli_fetch_assoc($rs_team)); ?>
                       <?php }else{ ?>
                        
                        <h1><center> 尚未新增團隊資料 </center></h1>
