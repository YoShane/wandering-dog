...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO slider (sOrder, sPicture, sPosition, sTitle, sContent, sScale, sButtonname, sButtonlink) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "show-slider.php";
  if (isset($_SERVER['QUERY_STRING'])) {
    $insertGoTo .= (strpos($insertGoTo, '?')) ? "&" : "?";
    $insertGoTo .= $_SERVER['QUERY_STRING'];
  }
   header ('Content-type: text/html; charset=utf-8');
echo "<script>javascript:alert('已成功新增滑動版面→" . $_POST['sTitle'] . "成功')</script>"; 
echo "<script>document.location.href='" . $insertGoTo . "';</script>";
}
?>
...
================================================== -->
          ...
          <div id="add-listing">
            ...
            <div class="add-listing-section">
              ...
              <div class="row with-forms">
                <div class="col-md-12">
                  <h5>標題</h5>
                  <input name="sTitle" type="text" required  class="search-field" placeholder="輸入標題" />
                </div>
              </div>
              <!-- Row -->
              <div class="row with-forms">
 <div class="col-md-12">
                  <h5>內容</h5>
                  <textarea name="sContent" required class="search-field" id="sContent"></textarea>
</div>
          ...
          <div class="submit-section">
             ...
             <div class="add-listing-headline margin-top-15">
               ...
               <div class="row with-forms">
                <div class="col-md-4">
									...
									<select name="sPosition" class="chosen-select-no-single" id="s" >
									  ...
									  <option value="3">靠右</option>
                                    </select>
				  </div>
                                
                  <div class="col-md-4">
					<h5>排序<span>(選填)</span><i class="tip" data-tip-content="數字越小，優先度越高。"></i></h5>
							  <input name="sOrder" type="number" required="required" id="sOrder" min="0" value="1">
						 </div>
                            
                  <div class="col-md-4">
					<h5>最大縮放<i class="tip" data-tip-content="本縮放代表使用者在瀏覽過程，滑動圖片放大的比例(有設定會比較有動態美，設置範圍建議100-110，可以設定完看看效果)"></i></h5>
					  <input name="sScale" type="number" required="required" id="sScale" min="100" value="100">
					</div>           
              ...
              <div class="col-md-6">
					<h5>按鈕文字</h5>
									<input name="sButtonname" type="text" required="required" id="sButtonname" value="了解更多">
								</div>
                                
                  <div class="col-md-6">
					<h5>按鈕連結</h5>
					  <input name="sButtonlink" type="text" required="required" id="sButtonline" value="#">
					</div>
