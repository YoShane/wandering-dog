...
$query_rs_delp = sprintf("SELECT * FROM post WHERE pId = %s", GetSQLValueString($Wandering,$colname_rs_delp, "int"));
...
if ((isset($_GET['pId'])) && ($_GET['pId'] != "")) {
  $deleteSQL = sprintf("DELETE FROM post WHERE pId=%s",
 ...
 $updateGoTo = "show-post.php";
  ...
  @unlink("../images/post/" . $row_rs_delp['pPicture']);
  
header ('Content-type: text/html; charset=utf-8');
echo "<script>javascript:alert('已成功刪除貼文→" . $row_rs_delp['pTitle'] . "成功')</script>"; 
