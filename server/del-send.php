...
$query_rs_dels = sprintf("SELECT * FROM send WHERE sId = %s", GetSQLValueString($Wandering,$colname_rs_dels, "int"));
...
if ((isset($_GET['sId'])) && ($_GET['sId'] != "")) {
  $deleteSQL = sprintf("DELETE FROM send WHERE sId=%s",
...
header ('Content-type: text/html; charset=utf-8');
echo "<script>javascript:alert('已成功刪除→" . $row_rs_dels['sName'] . "成功')</script>"; 
