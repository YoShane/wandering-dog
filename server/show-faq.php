...
if (isset($_GET['dId'])) {
  $colname_rs_dogpoint = $_GET['dId'];
}

$query_rs_dogpoint = sprintf("SELECT dName FROM dogpoint WHERE dId = %s", GetSQLValueString($Wandering,$colname_rs_dogpoint, "int"));
		...
		<div class="container">
			...
			<div class="right-side">
				...
				<div class="header-widget">
					...
					<a href="add-faq.php?dId=<?php echo $_GET['dId']; ?>" class="button border with-icon">新增狗場問答<i class="sl sl-icon-plus"></i></a>
				</div>
				<!-- Header Widget / End -->
			</div>
			<!-- Right Side Content / End -->
		...
		<div class="row">
			...
			<div class="col-lg-12 col-md-12">
				<div class="dashboard-list-box margin-top-0">
					<h4><?php echo $row_rs_dogpoint['dName']; ?>的FAQ</h4>
					<ul>
                    
                    <?php $havefaq = 0; if($totalRows_rs_faq != 0){ ?>
					   	...
					   	<li>
							<div class="list-box-listing">
								<div class="list-box-listing-content">
									<div class="inner">
										<h3><?php echo $havefaq; ?><a href="#"><?php echo $row_rs_faq['fQuestion']; ?></a></h3>
										<span><?php echo $row_rs_faq['fAnswer']; ?></span>
																			
									</div>
								</div>
							</div>
							<div class="buttons-to-right">
                         		<a href="edit-faq.php?fId=<?php echo $row_rs_faq['fId']; ?>&dId=<?php echo $_GET['dId']; ?>" class="button gray"><i class="sl sl-icon-note"></i> 編輯</a>
								<a href="del-faq.php?fId=<?php echo $row_rs_faq['fId']; ?>&dId=<?php echo $_GET['dId']; ?>" class="button gray"><i class="sl sl-icon-close" onclick="javascript:return confirm('確定刪除問答「<?php echo $row_rs_faq['fQuestion']; ?>」？')" ></i> 刪除</a>
							</div>
						</li>
                        <?php } while ($row_rs_faq = mysqli_fetch_assoc($rs_faq)); ?>
                       <?php }else{ ?>
                       
                      <h1><center> 尚未新增任何問答 </center></h1>
