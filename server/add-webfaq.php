...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO webfaq (wQuestion, wAnswer) VALUES (%s, %s)",
  ...
  $insertGoTo = "show-webfaq.php";
  if (isset($_SERVER['QUERY_STRING'])) {
    $insertGoTo .= (strpos($insertGoTo, '?')) ? "&" : "?";
    $insertGoTo .= $_SERVER['QUERY_STRING'];
  }
    header ('Content-type: text/html; charset=utf-8');
echo "<script>javascript:alert('已成功新增問答→" . $_POST['wQuestion'] . "成功')</script>"; 
...
================================================== -->
          ...
          <div id="add-listing">
            ...
            <div class="add-listing-section">
              ...
              <div class="row with-forms">
                <div class="col-md-12">
                  <h5>問題內容</h5>
                  <input name="wQuestion" type="text" required  class="search-field" placeholder="輸入問題" />
                </div>
              </div>
              <!-- Row -->
              <div class="row with-forms">
 <div class="col-md-12">
                  <h5>回覆內容</h5>
                  <textarea name="wAnswer" required class="search-field" id="fAnswer"></textarea>
</div>
