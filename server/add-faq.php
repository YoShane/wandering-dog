...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO faq (fLdid, fQuestion, fAnswer) VALUES (%s, %s, %s)",
  ...
  header ('Content-type: text/html; charset=utf-8');
echo "<script>javascript:alert('已成功新增問答→" . $_POST['fQuestion'] . "成功')</script>"; 
...
================================================== -->
          ...
          <div id="add-listing">
            ...
            <div class="add-listing-section">
              ...
              <div class="row with-forms">
                <div class="col-md-12">
                  <h5>問題內容</h5>
                  <input name="fQuestion" type="text" required  class="search-field" placeholder="輸入問題" />
                </div>
              </div>
              <!-- Row -->
              <div class="row with-forms">
 <div class="col-md-12">
                  <h5>回覆內容</h5>
                  <textarea name="fAnswer" required class="search-field" id="fAnswer"></textarea>
</div>
