...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE aboutus SET aTitle=%s, aContent=%s, aAboutpicture=%s, aVideo=%s, aBtitle1=%s, aBtitle2=%s, aBtitle3=%s, aBpicture1=%s, aBpicture2=%s, aBpicture3=%s, aBcontent1=%s, aBcontent2=%s, aBcontent3=%s WHERE aId=%s",
                       GetSQLValueString($Wandering,$_POST['aTitle'], "text"),
                       GetSQLValueString($Wandering,nl2br($_POST['aContent']), "text"),
					   GetSQLValueString($Wandering,$_name_, "text"),
                       GetSQLValueString($Wandering,$_POST['aVideo'], "text"),
                       GetSQLValueString($Wandering,$_POST['aBtitle1'], "text"),
                       GetSQLValueString($Wandering,$_POST['aBtitle2'], "text"),
                       GetSQLValueString($Wandering,$_POST['aBtitle3'], "text"),
                       GetSQLValueString($Wandering,$_POST['aBpicture1'], "text"),
                       GetSQLValueString($Wandering,$_POST['aBpicture2'], "text"),
                       GetSQLValueString($Wandering,$_POST['aBpicture3'], "text"),
                       GetSQLValueString($Wandering,$_POST['aBcontent1'], "text"),
                       GetSQLValueString($Wandering,$_POST['aBcontent2'], "text"),
                       GetSQLValueString($Wandering,$_POST['aBcontent3'], "text"),
                       GetSQLValueString($Wandering,1, "int"));

  
  $Result1 = mysqli_query($Wandering, $updateSQL) or die(mysqli_error());

  $updateGoTo = "edit-aboutus.php";
  if (isset($_SERVER['QUERY_STRING'])) {
    $updateGoTo .= (strpos($updateGoTo, '?')) ? "&" : "?";
    $updateGoTo .= $_SERVER['QUERY_STRING'];
  }
  header ('Content-type: text/html; charset=utf-8');
echo "<script>javascript:alert('已完成編輯關於我們')</script>"; 
...
================================================== -->
    ...
    <div class="dashboard-nav">
      <ul data-submenu-title="網站內容">
        ...
        <li class="active"><a> <i class="sl sl-icon-ghost"></i> 網站說明</a>
          <ul>
            <li class="active"><a href="edit-aboutus.php">關於我們</a></li>
          ...
          <div id="add-listing">
            ...
            <div class="add-listing-section">
              ...
              <div class="add-listing-headline">
                <h3><i class="sl sl-icon-note"></i>關於我們內容</h3>
              </div>
              <!-- Title -->
             <!-- Row -->
 ...
 <div class="col-md-12">
                  <h5>關於我們(標題)</h5>
                   <input name="aTitle" type="text"  class="search-field" value="<?php echo $row_rs_about['aTitle']; ?>" />
</div>

<div class="col-md-12">
                  <h5>關於我們(內容)</h5>
                  <textarea name="aContent" required class="search-field" id="aContent"><?php echo br2nl($row_rs_about['aContent']); ?></textarea>
</div>
               
               <div class="col-md-12">
                  <h5>關於我們影片(選填，優先圖片)->格式https://www.youtube.com/embed/</h5>
                   <input name="aVideo" type="text"  class="search-field" value="<?php echo $row_rs_about['aVideo']; ?>" />
</div>
              ...
              <div class="add-listing-headline">
                <h3><i class="sl sl-icon-tag"></i>下方3圖案</h3>
              </div>
                 <!-- Row -->
              <div class="row with-forms">
 <div class="col-md-4">
                  <h5>圖案左標題</h5>
                  <input name="aBtitle1" type="text"  class="search-field" value="<?php echo $row_rs_about['aBtitle1']; ?>" />
</div>
 <div class="col-md-4">
                  <h5>圖案中標題</h5>
                  <input name="aBtitle2" type="text"  class="search-field" value="<?php echo $row_rs_about['aBtitle2']; ?>" />
</div>
 <div class="col-md-4">
                  <h5>圖案右標題</h5>
                  <input name="aBtitle3" type="text"  class="search-field" value="<?php echo $row_rs_about['aBtitle3']; ?>" />
</div>
              ...
              <div class="row with-forms">
 <div class="col-md-4">
                  <h5>圖案左圖案<i class="tip" data-tip-content="參考上方Icon連結，設定flaticon系列，複製格式如flaticon-pets2(最前面小數點要刪掉)。"></i></h5>
                  <input name="aBpicture1" type="text"  class="search-field" value="<?php echo $row_rs_about['aBpicture1']; ?>" />
</div>
 <div class="col-md-4">
                  <h5>圖案中圖案</h5>
                  <input name="aBpicture2" type="text"  class="search-field" value="<?php echo $row_rs_about['aBpicture2']; ?>" />
</div>
 <div class="col-md-4">
                  <h5>圖案右圖案</h5>
                  <input name="aBpicture3" type="text"  class="search-field" value="<?php echo $row_rs_about['aBpicture3']; ?>" />
</div>
              ...
              <!-- Row / End -->
               ...
               <div class="row with-forms">
                <div class="col-md-12">
                  <h5>圖案左內容(選填)</h5>
                  <input name="aBcontent1" type="text"  class="search-field" value="<?php echo $row_rs_about['aBcontent1']; ?>" />
                </div>
              </div>
              ...
              <div class="row with-forms">
                <div class="col-md-12">
                  <h5>圖案中內容(選填)</h5>
                  <input name="aBcontent2" type="text"  class="search-field" value="<?php echo $row_rs_about['aBcontent2']; ?>" />
                </div>
              </div>
               ...
               <div class="row with-forms">
                <div class="col-md-12">
                  <h5>圖案右內容(選填)</h5>
                  <input name="aBcontent3" type="text"  class="search-field" value="<?php echo $row_rs_about['aBcontent3']; ?>" />
                </div>
              </div>
          ...
          <!-- Headline -->
          <div class="add-listing-headline">
            <h3><i class="sl sl-icon-picture"></i>關於我們圖片(選填，建議大小1200*900)</h3>
          </div>
          <!-- Dropzone -->
          <div class="submit-section">
             <div class="photoUpload">
                                ...
                                <input name="Filename" type="hidden" id="Filename" value="<?php echo $row_rs_about['aAboutpicture']; ?>">
							</div>
