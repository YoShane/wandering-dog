...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO post (pTitle, pPicture, pContent, pType, pShow, pOutline) VALUES (%s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "show-post.php";
  
    header ('Content-type: text/html; charset=utf-8');
echo "<script>javascript:alert('已成功新增貼文→" . $_POST['pTitle'] . "成功')</script>"; 
...
================================================== -->
          ...
          <div id="add-listing">
            ...
            <div class="add-listing-section">
              ...
              <div class="row with-forms">
                <div class="col-md-12">
                  <h5>貼文標題</h5>
                  <input name="pTitle" type="text" required  class="search-field" placeholder="請在此輸入標題" />
                </div>
              </div>
             <!-- Row -->
              <div class="row with-forms">
 <div class="col-md-12">
                  ...
                  <textarea name="pOutline" class="search-field" id="pOutline" placeholder="輸入貼文大綱"></textarea>
</div>
          ...
          <div class="add-listing-section margin-top-25">
            ...
            <div class="form">
              ...
              <textarea name="pContent" cols="40" rows="3" required class="WYSIWYG" id="summary" spellcheck="true"></textarea>
              ...
              <div class="col-md-4">
                           ...
                           <div class="col-md-8">
									  ...
									  <select name="pShow" required class="chosen-select" id="selectthings">
                                        <option value="0" selected="selected">顯示</option>
