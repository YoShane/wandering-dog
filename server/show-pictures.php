		...
		<div class="container">
			...
			<div class="right-side">
				...
				<div class="header-widget">
					...
					<a href="add-picture.php?dId=<?php echo $_GET['dId']; ?>" class="button border with-icon">新增照片<i class="sl sl-icon-plus"></i></a>
				</div>
				<!-- Header Widget / End -->
			</div>
			<!-- Right Side Content / End -->
          ...
          <div class="col-sm-6 col-md-6 col-lg-4 other" style="margin-bottom:50px;"><table border="0" cellspacing="0" cellpadding="0"  align="center">
              <tbody>
                ...
                <tr align="center">
                  ...
                  <a href="del-picture.php?pId=<?php echo $row_rs_pointp['pId']; ?>&dId=<?php echo $_GET['dId'];?>" class="button gray"  onclick="javascript:return confirm('確定刪除此圖片<?php echo $row_rs_pointp['pNote']; ?>？')" >刪除</a></td>
                </tr>
                </tbody>
              </table></div>
