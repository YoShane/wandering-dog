...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO listgallery (lName, lOrder, lPicture) VALUES (%s, %s, %s)",
  ...
  $insertGoTo = "show-gallery.php";
  if (isset($_SERVER['QUERY_STRING'])) {
    $insertGoTo .= (strpos($insertGoTo, '?')) ? "&" : "?";
    $insertGoTo .= $_SERVER['QUERY_STRING'];
  }
     header ('Content-type: text/html; charset=utf-8');
echo "<script>javascript:alert('已成功新增相簿類型→" . $_POST['lName'] . "成功')</script>"; 
          ...
          <div id="add-listing">
            ...
            <div class="add-listing-section">
              ...
              <div class="row with-forms">
                <div class="col-md-8">
                  <h5>相簿名稱</h5>
                  <input name="lName" type="text" required  class="search-field" placeholder="輸入相簿名稱" />
                </div>
                <div class="col-md-4">
                  <h5>相簿排序(選填，預設100放後面)<i class="tip" data-tip-content="狗場分類將會互相聯繫，此處可設定放在狗場項目前(0-49)或項目後(50-100)，排序數字越小則越優先，預設100放後面"></i></h5>
                  <input name="lOrder" type="number" required  class="search-field" placeholder="輸入排序號碼" max="100" min="0" value="100" />
                </div>
              </div>
