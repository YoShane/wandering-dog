...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO repdog (rLdid, rOrder, rName, rPicture, rGender, rAge, rIntroduction) VALUES (%s, %s, %s, %s, %s, %s, %s)",
  ...
  $insertGoTo = "show-repdog.php";
  $insertGoTo = $insertGoTo . "?dId=" . $_GET['dId'];
  
    header ('Content-type: text/html; charset=utf-8');
echo "<script>javascript:alert('已成功新增代表狗狗→" . $_POST['rName'] . "成功')</script>"; 
...
================================================== -->
          ...
          <div id="add-listing">
            ...
            <div class="add-listing-section">
              ...
              <div class="row with-forms">
                <div class="col-md-12">
                  <h5>狗狗名字</h5>
                  <input name="rName" type="text" required  class="search-field" placeholder="輸入稱呼" />
                </div>
              </div>
                ...
                <div class="col-md-4">
                  ...
                  <div class="col-md-4">
					<h5>大致年齡</h5>
							  <input name="rAge" type="text" required="required" id="rAge" value="">
						 </div>
                            
                  <div class="col-md-4">
					<h5>排序<span>(選填)</span><i class="tip" data-tip-content="數字越小，優先度越高。"></i></h5>
							  <input name="rOrder" type="number" required="required" id="rOrder" min="0" value="1">
						 </div>        
 ...
 <div class="col-md-12">
                  <h5>狗狗介紹&故事</h5>
                  <textarea name="rIntroduction" required class="search-field" id="rIntroduction"></textarea>
</div>
